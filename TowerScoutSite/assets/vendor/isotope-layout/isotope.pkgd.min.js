...
!(function (t, e) {
  ...
  (function (t, e) {
    ...
    const r = 'string' === typeof s.transition ? 'transition' : 'WebkitTransition';
    const a = 'string' === typeof s.transform ? 'transform' : 'WebkitTransform';
    const u = { WebkitTransition: 'webkitTransitionEnd', transition: 'transitionend' }[r];
    const h = {
      transform: a,
      transition: r,
  ...
  (function (t, e) {
    ...
    return (
      ...
      (o._manageStamp = function (t) {
        ...
        for (
          let h = this._getOption('originTop'), d = (h ? o.top : o.bottom) + i.outerHeight, l = a;
          l <= u;
          l++
        ) {
