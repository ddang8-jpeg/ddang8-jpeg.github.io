    ...
    venobox: function (options) {
      ...
      return this.each(function () {
        ...
        function checknav() {
          ...
          if (
            ...
            sharelinks = {
              ...
              linkedin: `<a target="_blank" href="https://www.linkedin.com/sharing/share-offsite/?url=${obj.prop(
                'href',
              )}">${linkedinIcon}</a>`,
        ...
        function loadVid(autoplay) {
          ...
          content.html(
            `<iframe class="venoframe vbvid" webkitallowfullscreen mozallowfullscreen allowfullscreen allow="autoplay" frameborder="0" src="${player}${videoObj.id}${queryvars}"></iframe>`,
          );
          updateoverlay();
        }
