        ...
        this.each(function () {
          ...
          function L() {
            (C = N.data('gall')),
              ...
              'iframe' !== N.data('vbtype') &&
                ...
                'ajax' !== N.data('vbtype') &&
                ((Q = {
                  pinterest: `<a target="_blank" href="https://pinterest.com/pin/create/button/?url=${N.prop(
                    'href',
                  )}&media=${N.prop('href')}&description=${_}">${Z}</a>`,
                  facebook: `<a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=${N.prop(
                    'href',
                  )}">${F}</a>`,
                  twitter: `<a target="_blank" href="https://twitter.com/intent/tweet?text=${_}&url=${N.prop(
                    'href',
                  )}">${G}</a>`,
                  linkedin: `<a target="_blank" href="https://www.linkedin.com/sharing/share-offsite/?url=${N.prop(
                    'href',
                  )}">${J}</a>`,
          ...
          function ke(e) {
            ...
            'vimeo' == i.type
              ...
              n.html(
                `<iframe class="venoframe vbvid" webkitallowfullscreen mozallowfullscreen allowfullscreen allow="autoplay" frameborder="0" src="${s}${i.id}${a}"></iframe>`,
              ),
              me();
          }
          function pe() {
